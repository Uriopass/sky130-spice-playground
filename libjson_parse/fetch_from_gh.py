...
all_cells = """sky130_fd_sc_hd__or4bb_4
...
sky130_fd_sc_hs__a31o_1""".splitlines()

def gen_url(cell_name):
    cell_name_short = "_".join(cell_name.split("__")[1].split("_")[0:-1])
    cell_library = cell_name.split("__")[0]

    postfix = ""
    if cell_library == "sky130_fd_sc_hs":
        postfix = "_ccsnoise"

    return f"https://raw.githubusercontent.com/google/skywater-pdk-libs-{cell_library}/refs/heads/main/cells/{cell_name_short}/{cell_name}__tt_025C_1v80{postfix}.lib.json"
