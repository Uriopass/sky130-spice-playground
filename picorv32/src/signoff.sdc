...
set input_delay_value [expr $::env(CLOCK_PERIOD) * $::env(IO_DELAY_CONSTRAINT) / 1000]
set output_delay_value [expr $::env(CLOCK_PERIOD) * $::env(IO_DELAY_CONSTRAINT) / 1000]
...
puts "\[INFO] Setting clock uncertainty to: 0.01"
set_clock_uncertainty 0.01 $clocks
